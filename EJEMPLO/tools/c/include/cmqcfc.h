 ...
 #define MQCMD_INQUIRE_ERROR_LOG        221
 ...
 #define MQRCCF_ATTR_VALUE_ERROR_QSG_QM 3390
 #define MQRCCF_AUTHORIZED              3391
 ...
 #define MQIAMO_MONITOR_TIMESTAMP       4
 ...
 #define MQIACF_EVENT_DUPLICATE_COUNT   1478
 #define MQIACF_ERROR_LOG_OPTIONS       1479
 #define MQIACF_LAST_USED               1479

 /* Error Log Option Values */
 #define MQERO_NONE                     0x00000000
 ...
 #define MQCACF_EVENT_DUPLICATE_FROM    3232
 #define MQCACF_ERROR_LOG_AFTER_ISOTIME 3233
 #define MQCACF_ERROR_LOG_NAME          3234
 #define MQCACF_ERROR_LOG_RECORD        3235
 #define MQCACF_ERROR_LOG_ISOTIME       3236
 #define MQCACF_LAST_USED               3236
 ...
 #define MQAUSC_FAILURES                0
 #define MQAUSC_ALLCONNS                1
 #define MQAUSC_ALLCHECKS               2
 ...
 #define MQRQ_CONN_AUTHORIZED           65
 #define MQRQ_OPEN_AUTHORIZED           66
 #define MQRQ_SUB_AUTHORIZED            67
 #define MQRQ_SUB_DEST_AUTHORIZED       68
