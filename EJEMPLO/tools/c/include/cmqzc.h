 ...
 #define MQZIC_VERSION_2                2
 #define MQZIC_CURRENT_VERSION          2

 /* Structure Length */
 #define MQZIC_LENGTH_1                 84
 #define MQZIC_LENGTH_2                 1108
 #define MQZIC_CURRENT_LENGTH           1108
 ...
 struct tagMQZIC {
   ...
   MQCHAR32    ApplIdentityData;    /* Application data relating to */
                                    /* identity */
   /* Ver:1 */
   MQCHAR1024  LongUserIdentifier;  /* Long user identifier */
   /* Ver:2 */
 };
